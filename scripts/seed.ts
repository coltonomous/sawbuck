...
const sampleListings = [
  ...
  {
    externalId: 'seed-fb-001',
    platform: 'facebook' as const,
    url: 'https://www.facebook.com/marketplace/item/seed-fb-001',
    title: 'Solid Cherry Bookcase — 5 shelves, dovetail joints',
    description: 'Hand-built cherry bookcase, about 40 years old. Five adjustable shelves. Dovetail joints on the top. Some light scratches. Measures 36"W x 12"D x 72"H. Must pick up.',
    askingPrice: 95,
    ...
    furnitureStyle: 'traditional',
    conditionScore: 7,
    conditionNotes: 'Solid cherry construction with dovetail joinery. Light surface scratches, easily addressed with a light sand and fresh finish. Adjustable shelf pins intact. Well-made piece with good bones.',
    woodSpecies: 'cherry',
    woodConfidence: 0.85,
    estimatedValue: 280,
    estimatedRefinishedValue: 420,
    dealScore: 2.95,
    analyzedAt: now,
    fingerprint: 'fb01a2b3c4d5e6f7fb01a2b3c4d5e6f7',
    matchedSearchTerms: JSON.stringify(['cherry bookcase', 'solid wood bookcase']),
  },
  {
    externalId: 'seed-fb-002',
    platform: 'facebook' as const,
    url: 'https://www.facebook.com/marketplace/item/seed-fb-002',
    title: 'Farmhouse Pine Dining Table — 8 ft',
    description: 'Big pine farm table. Seats 8-10 easy. Has character marks and some ring stains. Trestle base is solid. Free delivery within 10 miles.',
    askingPrice: 200,
    location: 'West Seattle',
    latitude: 47.5607,
    longitude: -122.3871,
    status: 'new' as const,
    fingerprint: 'fb02a2b3c4d5e6f7fb02a2b3c4d5e6f7',
    matchedSearchTerms: JSON.stringify(['pine table', 'farmhouse table']),
  },
  {
    externalId: 'seed-008',
    platform: 'craigslist' as const,
...
const sampleSearchConfigs = [
  ...
  { platform: 'facebook' as const, searchTerm: 'solid wood bookcase', location: 'seattle', isActive: true },
];
