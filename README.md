...
- **Refinishing Plans** — Detailed step-by-step instructions with product recommendations, time/cost estimates, and materials lists. Pre-generated by the pipeline for each concept — all data is ready before a user sees the listing.
